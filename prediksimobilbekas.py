...
mileage_km = st.number_input("Jarak Tempuh (km)", min_value=0.0, value=50000)
fueltype_input = st.selectbox("Jenis Bahan Bakar", fueltype_options)
tax_rupiah = st.number_input("Biaya Pajak (Rp)", min_value=0.0, value=2000000)
...
# Input budget user
user_budget = st.number_input("Masukkan budget Anda (Rp)", min_value=0.0, value=100_000_000, step=1_000_000)
