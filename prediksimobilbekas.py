...
mileage_km = st.number_input("Jarak Tempuh (km)", min_value=0, value=50000, format="%,d")
fueltype_input = st.selectbox("Jenis Bahan Bakar", fueltype_options)
tax_rupiah = st.number_input("Biaya Pajak (Rp)", min_value=0, value=2000000, format="%,d")
